...
dataset_coco = dict(
    ...
    dataset=dict(
        ...
        data_root=data_root,
        data_mode=data_mode,
        ann_file='/RnD/mmpose/dog_mmpose/animal_train.json',
        data_prefix=dict(img='/RnD/mmpose/dog_mmpose/train'),
        pipeline=[],
    ),
    # times=3)
...
val_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_root=data_root,
        data_mode=data_mode,
        ann_file='/RnD/mmpose/dog_mmpose/animal_val.json',
        # bbox_file='data/coco/person_detection_results/'
        # 'COCO_val2017_detections_AP_H_56_person.json',
        data_prefix=dict(img='/RnD/mmpose/dog_mmpose//val'), # 수정
        test_mode=True,
